		...
		detectIE: function() {
			...
			if(this.detectIECheck()) {
				var body = document.querySelector("body"),
					msg = 'Infelizmente, o navegador Internet Explorer que você usa está desatualizado e não pode exibir o site normalmente. <br> Por favor, abra o site em outro navegador';
